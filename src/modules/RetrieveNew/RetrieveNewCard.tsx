...
export const RetrieveNewCard = ({card}: { card: INewDTO }) => {
    ...
    return <div className={`relative flex flex-col justify-between bg-white dark:bg-zinc-100  dark:text-zinc-800 w-10/12 h-full  p-6 rounded-xl drop-shadow-md duration-700`}>
        <div className="newCard mb-12">
            <div className={'w-full h-auto flex justify-center items-center'}>
                <Image src={card.image} alt={card.title} height={250} width={300} unoptimized={true}
                       className={`rounded-xl drop-shadow-md max-h-[250px]`}/>
            </div>
            <br/>
