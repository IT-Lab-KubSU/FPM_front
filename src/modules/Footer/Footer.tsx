...
const FooterLink = ({children, href}: { children: ReactNode, href: string }) => {
    return <Link href={href} target={"_blank"} className={"fill-white text-white hover:fill-[#5C83E7] hover:text-[#5C83E7] duration-500"}>
        {children}
    </Link>
}
...
export default function Footer() {
    return <footer className="bg-[#2B303D] text-zinc-100 w-full">
        <div className="container pt-12 px-12 mx-auto grid grid-cols-1 lg:grid-cols-4 gap-8 p-3">
            ...
            <div>
                <div className={"grid grid-cols-1 gap-4 text-lg font-extralight"}>
                    <FooterLink href={"#"}>
                        Бакалавриат
                    </FooterLink>
                    <FooterLink href={"#"}>
            ...
            <div className={"font-extralight grid grid-cols-1 gap-4"}>
                <div className={"text-xl grid grid-cols-1 gap-2"}>
                ...
                <div className={"text-2xl"}>
                    ...
                    <div className={"py-4 grid grid-cols-4"}>
                        ...
                        <div>
                            <FooterLink href="https://t.me/fctandam">
                                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                                     width="48" height="48"
                                     viewBox="0 0 48 48">
                                    <path
                        ...
                        <div>
                            <FooterLink href="https://www.youtube.com/@user-hr3lc4qj3z/featured">
        ...
        <div className={"text-center py-2 font-extralight"}>
