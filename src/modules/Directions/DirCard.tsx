    ...
    return (<UseClient>
        <>
            <div onClick={() => set(index)}
                 className={`bg-white p-8 w-full ${open ? "pb-12" : ""} cursor-pointer duration-700 ease-in-out rounded-3xl mb-4 text-2xl shadow-2xl flex flex-col lg:flex-row justify-start`}>
