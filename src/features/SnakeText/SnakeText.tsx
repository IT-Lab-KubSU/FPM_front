...
export default function SnakeText({text, mainText}: IProps) {
    ...
    return (<>
        <svg className={"snake hidden md:block"} viewBox="0 0 1920 509" fill="none" xmlns="http://www.w3.org/2000/svg"
             style={{
            ...
            <text y="40" letterSpacing="-0.02em" fill="#2B2D33"
                  ...
                  fontSize="80">
                <textPath ref={snake} href="#text-curve" fontWeight="900" startOffset={0} opacity={0}
